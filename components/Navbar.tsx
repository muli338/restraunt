...
const Navbar = () => {
    ...
    return (
        ...
        <div className='h12 text-red-500 p-4 flex justify-between items-center border-b-2 border-b-red-500 uppercase md:h-24 lg:px-20 xl:px-40'>
            {/* LEFT LINKS */}
